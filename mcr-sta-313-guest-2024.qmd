...
## {background-image="img/national_mortality_rates-wide.png" background-size="contain"}


## {background-image="img/gender-gap.png" background-size="cover"}

## {background-image="img/allen-downey-gap.png" background-size="contain"}

:::{.aside}
Allen Downey
:::

## {background-image="img/james-traina-gap.png" background-size="contain"}
...
## {background-image="img/victoriano-izquierdo-gap.png" background-size="contain"}

:::{.aside}
Victoriano Izquierdo
:::

## {background-image="img/julius-kölzer-gap.png" background-size="contain"}

:::{.aside}
Julius Kölzer
:::

## {background-image="img/fats-and-oils.png" background-size="contain"}

## {background-image="img/fats-and-oils-2.png" background-size="contain"}

## Global Sea Surface Temperature

![](img/sea-surface-temp.png)
